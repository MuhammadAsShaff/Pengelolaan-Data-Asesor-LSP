                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-header">
                        <h4 class="modal-title">Sertifikat Anda</h4>
                ...
                <div class="modal fade" id="delete<?= $sft['nomor_sertifikat'] ?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <!-- Modal body -->
                      <form method="post" action="<?= site_url('sertifikat/deleteSertifikatAsesor') ?>">
                        <div class="modal-body">
                ...
                <div class="modal fade" id="edit<?= $sft['nomor_sertifikat'] ?>">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <!-- Modal body -->
                      <form method="post" action="<?= site_url('sertifikat/updateSertifikatAsesor') ?>"
...
<div class="modal fade" id="tambahSertifikat">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <form method="post" action="<?= site_url('sertifikat/uploadSertifikatAsesor') ?>" enctype="multipart/form-data">

        <div class="modal-body">
          <h6>Nomor Sertifikat</h6>
          <input type="number" name="nomor_sertifikat" placeholder="Nomor Sertifikat" class="form-control" required>
          <input type="hidden" name="nomor_registrasi_asesor" value="<?php echo $nomor_registrasi_asesor ?>"
            class="form-control" required>
          <br>
          <h6>Tanggal Aktif</h6>
